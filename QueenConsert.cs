...
{
    public partial class QueenConsert : Form
    {
        ...
        public void update_db(char new_seat_status, int seat_id)
        {
            ...
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                try
                {
                    ...
                    string updateSql = $"UPDATE Queen_concert SET seat_status = '{new_seat_status}' WHERE seat_id = {seat_id};";
        ...
        public void get_initial_data_db()
        {
            ...
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                try
                {
                    ...
                    string query = $"SELECT seat_id, seat_status FROM Queen_concert;";
        ...
        private void QueenConsert_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void QueenConsert_Load(object sender, EventArgs e)
        {
