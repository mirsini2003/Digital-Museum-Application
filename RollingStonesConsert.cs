...
{
    [Serializable]
    public partial class RollingStonesConsert : Form
    {
        private Panel[] seats = new Panel[30];
        char[] seat_status = new char[30];

        public RollingStonesConsert()
        {
        ...
        public void update_db(char new_seat_status, int seat_id)
        {
            ...
            // Connection string
            //string connectionString = "Data Source=C:\\Users\\arist\\Desktop\\ergasia_alilepidrasi\\db\\Erg_AYY.v1.db;Version=3;";
            ...
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                try
                {
                    ...
                    string updateSql = $"UPDATE Rollingstones_concert SET seat_status = '{new_seat_status}' WHERE seat_id = {seat_id};";
        ...
        public void get_initial_data_db()
        {
            ...
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                try
                {
                    ...
                    string query = $"SELECT seat_id, seat_status FROM Rollingstones_concert;";
        ...
        private void RollingStonesConsert_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
